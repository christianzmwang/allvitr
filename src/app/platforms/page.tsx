          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center">
            ...
            <div className="flex justify-center">
              <div className="text-left text-white max-w-xl md:max-w-2xl w-100">
                <p className="text-lg md:text-xl font-bold">A suite of tools to discover signals, unify knowledge, and drive decisions.</p>
        ...
        <div className="mt-[10vh] min-h-[80vh] flex items-center py-20 md:py-36">
          <div className="container-95">
            ...
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-6xl font-bold text-white mb-6">Hugin</h2>
            ...
            <div className="bg-gradient-to-r from-sky-500/10 to-purple-500/10 border border-sky-400/30 p-8 md:p-12 mb-16">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div>
                  <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">Why Signals Matter</h3>
                  ...
                  <div className="mt-6 flex items-center space-x-2">
                    ...
                    <span className="text-sky-400 font-medium">Real-time monitoring</span>
                  </div>
                </div>
                <div className="relative">
                  <div className="aspect-square w-full bg-gradient-to-br from-sky-500/20 to-purple-500/20 border border-sky-400/30 flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <div className="text-sky-400 font-semibold">Live Signals</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
              <div className="bg-white/5 p-8 border border-white/10 hover:border-sky-400/30 transition-colors">
                ...
                <h4 className="text-xl font-semibold text-white mb-3">Prioritize Outreach</h4>
                <p className="text-gray-300">Focus on accounts actively evaluating solutions, not just a static ICP list.</p>
              </div>
              <div className="bg-white/5 p-8 border border-white/10 hover:border-sky-400/30 transition-colors">
                <div className="text-3xl mb-4">⏱️</div>
                <h4 className="text-xl font-semibold text-white mb-3">Shorten Cycles</h4>
                <p className="text-gray-300">Start with context. Tailor messaging and speed up qualification.</p>
              </div>
              <div className="bg-white/5 p-8 border border-white/10 hover:border-sky-400/30 transition-colors">
                <div className="text-3xl mb-4">🏆</div>
                <h4 className="text-xl font-semibold text-white mb-3">Increase Win Rate</h4>
            ...
            <div className="mb-16">
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-8 text-center">Signal Types</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-gradient-to-br from-orange-500/10 to-red-500/10 p-6 border border-orange-400/30">
                  <h4 className="text-lg font-semibold text-white mb-2">Integration Mentions</h4>
            ...
            <div className="bg-gradient-to-r from-gray-900/50 to-black/50 border border-white/10 p-8 md:p-12">
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-8 text-center">How Hugin Works</h3>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div className="text-center">
                  ...
                  <h4 className="text-lg font-semibold text-white mb-2">Monitor</h4>
                  <p className="text-gray-300 text-sm">Track web sources and data feeds</p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-gray-300 text-sm">Identify relevant signals in real-time</p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-gray-300 text-sm">Score and prioritize opportunities</p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-gray-300 text-sm">Engage with perfect timing</p>
                </div>
              </div>
            </div>
          </div>
