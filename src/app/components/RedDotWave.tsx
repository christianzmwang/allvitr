...
export default function RedDotWave({
  ...
  gridSize = 300, // number of dots per side (squared total)
  ...
  initialCameraPosition = [0, 8.5, 26], // initial camera position
  ...
  return (
    <div ref={containerRef} className="relative h-[60vh] w-full overflow-hidden bg-black">
