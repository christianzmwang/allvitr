    ...
    <div className="min-h-screen flex flex-col relative pt-24">
      ...
      >
        <div className="relative z-10 max-w-2xl w-full text-center">
          <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4">Allvitr Platforms</h1>
          <p className="text-md md:text-lg text-gray-400">
            A suite of tools to discover signals, unify knowledge, and drive decisions.
          </p>
        </div>
      </section>
      ...
      <main className="flex-1 px-6 md:px-8 py-12 md:py-16">
        <div className="w-[95%] md:max-w-[80%] mx-auto space-y-24">
          {/* Hugin */}
            ...
            <div className="relative overflow-hidden rounded-3xl border border-white/10 p-8 md:p-12 bg-gradient-to-br from-red-500/10 via-black/30 to-black/60">
              <div className="max-w-3xl">
                ...
                <p className="text-gray-300 text-lg">
                  Real-time market research. Index the public web and third-party data to surface timely signals on
              ...
              <div className="mt-12">
                <h3 className="text-2xl md:text-3xl font-bold text-white mb-6 text-center">Why Signals Matter</h3>
                <p className="text-base md:text-lg text-gray-300 text-center max-w-3xl mx-auto mb-10">
                  ...
                  budget, urgency, and momentum. Hugin helps you identify those moments—consistently.
                </p>
              ...
              <div className="mt-16">
                <h3 className="text-2xl md:text-3xl font-bold text-white mb-6 text-center">Example Signals</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  <div className="bg-white/5 p-6 rounded-lg text-center border border-white/10">
                    <h4 className="text-lg font-bold text-white mb-2">New Product Launch</h4>
                    <p className="text-gray-300">
                      A company launching a new product is a strong signal that they are investing in growth and may
                      need new tools and services to support their launch.
                    </p>
                  </div>
                  <div className="bg-white/5 p-6 rounded-lg text-center border border-white/10">
                    <h4 className="text-lg font-bold text-white mb-2">Executive Hire</h4>
                    <p className="text-gray-300">
                      A new executive, especially in a key role like marketing or sales, often brings in new tools and
                      strategies.
                    </p>
                  </div>
                  <div className="bg-white/5 p-6 rounded-lg text-center border border-white/10">
                    <h4 className="text-lg font-bold text-white mb-2">Geographic Expansion</h4>
                    <p className="text-gray-300">
                      Expansion into a new market signals a need to understand the local landscape and find partners.
                    </p>
                  </div>
                  <div className="bg-white/5 p-6 rounded-lg text-center border border-white/10">
                  ...
                  <div className="bg-white/5 p-6 rounded-lg text-center border border-white/10">
                    <h4 className="text-lg font-bold text-white mb-2">Increased Hiring</h4>
                    <p className="text-gray-300">
                      A surge in hiring within a department can signal a new focus that may require new tools.
                    </p>
                  </div>
                  <div className="bg-white/5 p-6 rounded-lg text-center border border-white/10">
                    <h4 className="text-lg font-bold text-white mb-2">Regulatory Changes</h4>
                    <p className="text-gray-300">
                      New regulations can force companies to adopt technologies and processes to ensure compliance.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <section id="munin" data-nav-theme="dark" className="scroll-mt-32">
            <div className="relative overflow-hidden rounded-3xl border border-white/10 p-8 md:p-12 bg-gradient-to-br from-sky-400/10 via-black/30 to-black/60">
              <div className="max-w-3xl">
                ...
                <p className="text-gray-300 text-lg">
                  Secure company knowledge base and analytics. Bring your documents, notes, and data together with
                  governance and search that scales.
                </p>
              </div>
            </div>
          </section>
          ...
          <section id="odin" data-nav-theme="dark" className="scroll-mt-32">
            <div className="relative overflow-hidden rounded-3xl border border-white/10 p-8 md:p-12 bg-gradient-to-br from-gray-400/10 via-black/30 to-black/60">
              <div className="max-w-3xl">
                ...
                <p className="text-gray-300 text-lg">
                  Executive dashboard for real-time KPIs. A single pane of glass across revenue, product, and
                  operations—updated continuously.
                </p>
              </div>
            </div>
          </section>
